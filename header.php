      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav me-auto mb-2 mb-md-0">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="../proyectofinal/almacenamiento.php">Productos</a>
            </li>
            <li class="nav-item">
              <?php
              if (isset($_SESSION["userid"])) {
                echo '<a class="nav-link" href="../proyectofinal/ventaMayorista.php">Venta Mayorista</a>';
              } else {
                echo '<a class="nav-link" href="../proyectofinal/ventaMayoristaSignup.php">Venta Mayorista</a>';
              }
              ?>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../proyectofinal/quienesSomos.php">Quienes Somos</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../proyectofinal/contacto.php">Contacto</a>
            </li>
          </ul>
          <form class="d-flex">
            <?php
